    ...
    <View className="mx-4 mb-6">
        ...
        <View className="flex-1 bg-white rounded-2xl p-4 mr-2 shadow-sm shadow-black/5">
          <View className="flex-row items-center justify-between">
            <View className="flex-1">
              <Text className="text-sm font-rubik text-gray-500 mb-1">
                Available
              </Text>
            ...
            <View className="w-10 h-10 bg-green-100 rounded-full items-center justify-center">
              <Image
                source={icons.wallet}
                className="w-5 h-5 tintColor-green-600"
              />
            </View>
          </View>
        </View>
          ...
          <View className="flex-row items-center justify-between">
            ...
            <View className="w-10 h-10 bg-orange-100 rounded-full items-center justify-center">
              <Image
                ...
                className="w-5 h-5 tintColor-orange-600"
              />
            </View>
          </View>
        </View>
      ...
      <View className="bg-white rounded-2xl p-6 shadow-sm shadow-black/5">
        <View className="flex-row items-center justify-between mb-6">
          ...
          >
            <Text className="text-sm font-rubik text-primary-600 mr-1">
              View All
            </Text>
            <Image
              source={icons.rightArrow}
              className="w-4 h-4 tintColor-primary-600"
            />
          </TouchableOpacity>
        </View>
